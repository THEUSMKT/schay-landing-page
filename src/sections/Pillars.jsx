...
export default function Pillars() {
  return (
    <section id="como-funciona" className="border-y border-white/10 bg-navy-850">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 sm:px-8 sm:py-16 md:grid-cols-3 md:gap-0 md:divide-x md:divide-white/10">
        {PILLARS.map((pillar, index) => (
          ...
          >
            <span className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-white/5 text-accent-400 ring-1 ring-white/10">
